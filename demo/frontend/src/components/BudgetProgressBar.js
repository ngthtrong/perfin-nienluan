  ...
  return (
    <View>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 2 }}>
        <Text style={{ color: c.textMuted, fontSize: 12, fontWeight: '500' }}>{formatVND(spent)} đã chi</Text>
        <Text style={{ fontSize: 12, fontWeight: '800', color }}>{Number(percentage).toFixed(1)}%</Text>
      </View>
    </View>
  );
}
