...
1. **Viết lại hay cải tiến?** →  cải tiến tiến hóa (GĐ 1→4), không viết lại.
2. **Schema: Phương án A (chuẩn hóa đủ)?**
3. **Redis: làm ngay GĐ 1 hay để sau?** (pending-state là phần đáng làm nhất trước tiên).
4. **Ưu tiên tính năng mới nào?** làm hết
5. **AI: chuyển sang function-calling/tool-use ?**
