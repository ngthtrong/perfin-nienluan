...
Unit Testing & Kiểm thử từng hàm/module riêng lẻ, đặc biệt các hàm xử lý logic nghiệp vụ (tính toán số dư, kiểm tra ngưỡng ngân sách) và các hàm tiện ích (format tiền tệ, parse ngày tháng) & Jest (Node.js, React Native) \\ \hline
...
System Testing & Kiểm thử toàn hệ thống end-to-end, mô phỏng luồng sử dụng thực tế từ giao diện mobile đến database & Appium, Detox \\ \hline
