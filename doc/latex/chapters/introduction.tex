...
\begin{itemize}
    \item \textbf{Phạm vi phát triển:} Xây dựng ứng dụng mobile đa nền tảng (Android và iOS) sử dụng React Native (kết hợp Expo), hệ thống backend API với Node.js, và tích hợp các dịch vụ AI của Google (Gemini, Vision, Speech-to-Text).
