...
\begin{longtable}{@{}C{0.9cm}L{3.0cm}L{10.4cm}@{}}
  ...
  30 & UI & User Interface --- giao diện người dùng \\
  31 & UML & Unified Modeling Language --- ngôn ngữ mô hình hóa thống nhất \\
  32 & VND & Đồng Việt Nam \\
  33 & WER & Word Error Rate --- tỷ lệ lỗi từ \\
  \bottomrule
\end{longtable}
