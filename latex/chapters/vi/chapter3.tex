...
\widereportfigure{14-usecase-overview.pdf}{Sơ đồ ca sử dụng tổng thể của PERFIN. Người dùng là tác nhân chính của toàn bộ mười hai chức năng; Dịch vụ AI ngoài, Worker nền và Quản trị viên phát triển chỉ tham gia các ca liên quan và nằm ngoài biên tin cậy dữ liệu.}{fig:usecase-overview}
