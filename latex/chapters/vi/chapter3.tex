...
\begin{longtable}{@{}L{3.3cm}L{4.2cm}L{2.4cm}L{3.4cm}@{}}
  ...
  \midrule
  \endhead
  Backend \code{npm test} sau sửa & 178/178 test đạt, 0 thất bại & \statusmeasured & Unit/service trên 37 tệp test; gồm transaction, concurrency, recurring, health, importer, time-series và user scope. Mốc 16/07/2026 là 100/100 trước khi mở rộng bộ test. \\
