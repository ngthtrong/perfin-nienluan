...
\begin{frtable}{Đặc tả FR-06 --- Chuyển ví và dòng tiền đặc biệt}{tab:fr06}
  ...
  \textbf{Luồng luân phiên/đặc biệt} & Ví trùng/thiếu, amount/date sai hoặc ví ngoài hồ sơ làm rollback. Không từ chối chỉ vì ví nguồn sẽ âm. \frtablerow
\end{frtable}
...
\begin{frtable}{Đặc tả FR-07 --- Phân tích dữ liệu tài chính}{tab:fr07}
  ...
  \textbf{Mô tả tóm tắt} & Tính facts bằng hàm xác định trên dữ liệu chưa xóa và trục thời gian có zero-fill. \frtablerow
  \textbf{Các mối quan hệ} & Đọc FR-05; cung cấp facts cho FR-08 và FR-11. \frtablerow
  \textbf{Luồng xử lý bình thường của sự kiện} & \textbf{Bước 1:} Chọn loại phân tích và kỳ. \textbf{Bước 2:} Truy vấn dữ liệu theo hồ sơ. \textbf{Bước 3:} Zero-fill và kiểm tra số mẫu. \textbf{Sub 1:} Chạy giải thuật. \textbf{Bước 4:} Trả facts, method và warning. \frtablerow
...
\begin{frtable}{Đặc tả FR-10 --- Mục tiêu và mô phỏng what-if}{tab:fr10}
  ...
  \textbf{Các luồng sự kiện con (Subflows)} & \textbf{Sub 1 --- Tính toán:} (1) Saving/purchase tính phần còn thiếu; (2) debt payoff mô phỏng dư nợ theo tháng. \frtablerow
  \textbf{Luồng luân phiên/đặc biệt} & Contribution bằng 0 trả thời gian không xác định; payment không bù lãi hoặc horizon quá 600 tháng trả cảnh báo, không bịa ngày hoàn tất. \frtablerow
\end{frtable}
