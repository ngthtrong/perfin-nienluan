...
\widereportfigure{figures/drawio/01-system-context.png}{Ngữ cảnh và phạm vi của PERFIN; các dịch vụ LLM, OCR và STT nằm ngoài biên tin cậy dữ liệu.}{fig:system-context}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}L{1.0cm}Y Y L{2.0cm}@{}}
    ...
    O5 & Đánh giá nguyên mẫu bằng chiến lược kiểm thử lai tối giản. & Dùng test tự động cho lõi dữ liệu--giải thuật và ca chức năng thủ công cho luồng chính; nêu rõ ranh giới mock/live và UAT. & Tuần 13 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{enumerate}
  ...
  \item \textbf{Kiểm thử:} dùng unit/hồi quy trên fixture có kiểm soát, kiểm tra tích hợp nội bộ bằng mock hoặc bộ nhớ trong, và các kịch bản chức năng thủ công do tác giả thực hiện. Kết quả được giới hạn đúng phạm vi, không đồng nhất kiểm thử thủ công với UAT hay độ chính xác OCR/STT.
\end{enumerate}
