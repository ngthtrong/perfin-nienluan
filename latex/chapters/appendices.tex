...
Mỗi sơ đồ có nguồn chỉnh sửa tại \path{figures/drawio} và bản render tại \path{figures/rendered}. Báo cáo liên kết bản PDF; PNG/SVG dùng cho xem nhanh và tài liệu web. Thuật ngữ trong sơ đồ phải đồng nhất với báo cáo và phân biệt lõi xác định, LLM, dữ liệu bền vững, state tạm cùng dịch vụ ngoài.
...
\begin{longtable}{@{}C{1.0cm}L{4.2cm}L{4.5cm}L{3.0cm}@{}}
  ...
  4 & Lớp miền nghiệp vụ & \path{04-domain-class} & Hình~\ref{fig:domain-class} \\
...
\chapter{Biên bản kết quả ngày 15/07/2026}

\begin{longtable}{@{}L{4.0cm}L{10.5cm}@{}}
  \toprule
  \textbf{Trường} & \textbf{Giá trị đã ghi nhận} \\
  \midrule
  Commit & Không được khóa trong đợt audit; cần bổ sung khi chốt bản nộp. \\
  Thời gian chạy & Ngày 15/07/2026, workspace phát triển. \\
  Backend test sau sửa & 18/18 tệp pass, 0 fail; khoảng 1,028 giây. \\
  ...
  Frontend export & Thành công 652 module, bundle JavaScript khoảng 1,49 MB. \\
  PostgreSQL/Redis live & Không được xác nhận trong đợt đo; không suy diễn từ unit test. \\
