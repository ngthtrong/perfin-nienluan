...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}L{3.6cm}Y Y@{}}
    ...
    O3 --- Analytics algorithms & Analytics, goal, budget, and feedback functions plus automated tests; feedback measured before/after. & 178/178 tests pass; correction retrieval lifts holdout accuracy 0\% $\to$ 68.19\%. Broader labeled data still needed. \\
