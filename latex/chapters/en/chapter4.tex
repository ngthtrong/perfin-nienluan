...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}L{3.6cm}Y Y@{}}
    ...
    O2 --- Multimodal pipeline & Tool schema, parser, media adapters, preview/state, plus an ablation on a labeled set. & Flow implemented and now measured: local parser macro-F1 0.177, Gemini 0.561 on the same sample. \\
